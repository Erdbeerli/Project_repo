...
#PLANT RECOMMENDATION: Filter Function HERBS ONLY
...
#PLANT RECOMMENDATION: Filter Function Vegetables ONLY
...
# Herbs: Basil, Parsley, Thyme, Oregano, Rosemary, Chives, Sage, Mint, Cilantro, Dill, Fennel, Lavender, Tarragon, Lemon Balm, Marjoram, Chamomile, Bay Laurel, Sorrel, Lovage, Cress
    ...
    crop_name = "Beans, Onion, Pumpkin", "Squash", "Carrot", "Potato, Onion", "Radish", "Lettuce", "Tomato, Zucchini", "Zucchini", "Spinach", "Radish", "Kale", "Broccoli", "Cauliflower", "Peas", "Beans", "Leek", "Swiss Chard, Cabbage", "Beetroot", "Pumpkin", "Brussels Sprouts", "Celery", "Sweet Corn", "Turnip", "Parsnip", "Eggplant", "Pepper", "Cucumber"
    sun_requirement = st.selectbox("☀️ How sunny is your place?", ("Any", "Full Sun", "Partial Sun"))
...
def main():
    ...
    if st.sidebar.button("Vegetables Recommendations"):   
